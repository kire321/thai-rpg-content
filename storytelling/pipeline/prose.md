...
Search your draft for each of these strings and rewrite any sentence containing them: "as if", "ghost", "dead", "died", "death", "forge", "not the ", "No. Only", " Not " (sentence-initial), "or both". Then verify every Thai anchor phrase from the plan's TAG PLAN appears VERBATIM (copy it character-for-character). Verify each act is headed exactly "## Act 1" ... "## Act 4". Verify every PASS:/FAIL: line is the PC speaking in first person, beginning with "I".
