...
Places in Chantara should serve dual purposes: they are physical settings where scenes occur, and they are also tonal environments where different acoustic conditions create different narrative possibilities. Each location has a default "ambient frequency" that shapes what kinds of interactions are possible.

## The Ten Locations

### Khrueang Market
The central marketplace of the largest skycity, a hub of commerce and gossip. The ambient noise of thousands of conversations creates a constant background hum that makes precise tonal work difficult. Good for social encounters, trade negotiations, and overhearing rumors.

### The Anchor Spire
A massive resonance anchor extending from a floating island into the lattice below. The harmonic vibration creates a powerful, steady tone that calms emotions but makes stealth impossible. Good for dramatic confrontations and moments of revelation.

### Phrao Monastery
The monastery-city where Listeners study the lattice's song. The carefully maintained acoustic environment allows for precise tonal experiments. Good for gaining knowledge, spiritual encounters, and technical training.

### The Lattice Surface
The crystalline ground itself, seen from a safe observation platform. The shifting patterns of light and sound are beautiful but dangerous. Good for moments of awe, scavenging missions, and reminders of the world's perilous nature.

### Resonance Ship Deck
The deck of a ship navigating between skycities. The wind, the ship's engine tones, and the ever-changing lattice below create a dynamic environment. Good for travel sequences, ship-to-ship encounters, and moments of isolation.

### Tha Khwae Scrapyard
The industrial edge of the scavenger city, where old ships are broken down. The clanging metal and running engines create a harsh acoustic environment. Good for mechanical problem-solving, underworld contacts, and salvage missions.
